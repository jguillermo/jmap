...
module.exports = function (grunt) {
    ...
    var globalConf = {
        ruta_dist: './../../../public/f/wread/',
        ruta_dist_dev: './../../../public/f/wread-dev/',
        ...
        copy: {
            ...
            bw: {
                files: [
                  ...
                  {expand: true,flatten: true, src: ['bower_components/angular-md5/*'], dest: '<%= globalConfig.ruta_dist_dev  %>plugin/angular-md5', filter: 'isFile'},
                  ...
                  {expand: true,flatten: true, src: ['bower_components/zeroclipboard/dist/*'], dest: '<%= globalConfig.ruta_dist_dev  %>plugin/zeroclipboard', filter: 'isFile'},
                  {expand: true,flatten: true, src: ['bower_components/ng-clip/dest/*'], dest: '<%= globalConfig.ruta_dist_dev  %>plugin/ng-clip', filter: 'isFile'},
