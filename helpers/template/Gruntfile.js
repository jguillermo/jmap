    ...
    grunt.initConfig({
        ...
        sass:{
            dist:{
                ...
                files:{
                    '.tem/css/app.skin-1.css':'app/sass/skin/skin-1/core.scss',
        ...
        concat:{
            ...
            dist_js:{
                ...
                files: {
                    ...
                    '../js/jtools/jtools-service-angularjs/jtools-services-angularjs.min.js',
                    '../js/jtools/jtools-google-chart-angularjs/jtools-google-chart-angularjs.min.js',
                    ...
                    '.tem/js/app.min.js'],
                    '<%= globalConfig.ruta_dist  %>js/jsapi<%= globalConfig.codigo_unico %>.min.js': [
                    '../js/jtools/jtools-jsapi/jsapi.min.js'],
                }
            }
        },
        jshint: {
