...
<table border="0" cellpadding="2" cellspacing="3" width="100%" class="form-table">
          <tr>            	  
            ...
            <td  class="bg" colspan=3>10443262399 - GUILLERMO INCHE JOSE ANTONIO</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="bg" colspan=3>DNI  44326239 
            
            	 - GUILLERMO INCHE, JOSE ANTONIO
            ...
            <tr>
              ...
              <td class="bg" colspan=1>31/05/2011</td>
              <td width="27%" colspan=1 class="bgn">Fecha de Inicio de Actividades:</td>
              <td class="bg" colspan=1> 27/06/2011</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="bg" colspan=3>CAL.GENERAL VALDEZ NRO. 445 LIMA                                                                                                                               - LIMA                                                                                                                               - LA VICTORIA</td>
            </tr>
<!--     SE COMENTO POR INDICACION DEL PASE PAS20134EA20000207  -->
<!--            <tr>  -->
<!--              <td class="bgn" colspan=1>Tel&eacute;fono(s):</td>  -->
<!--              <td class="bg" colspan=1>/ 995513627 </td> -->
...
<!--             </tr>  -->
          ...
          <tr>
            ...
            <td class="bg" colspan=3>
                ...
                <option value="00" > RECIBOS POR HONORARIOS     AFILIADO DESDE 31/05/2011</option>
          ...
          <tr>
            ...
            <td class="bg" colspan=3>31/05/2011</td>
          </tr>
          <tr>
            <td class="bgn" colspan=1>Comprobantes Electr&oacute;nicos: </td> 
            <td class="bg" colspan=3>RECIBO POR HONORARIO (desde 31/05/2011)</td>
          </tr>
	...
	<tr>
  		<td class="t1"><font size="2">CONSULTA RUC: 10443262399 - GUILLERMO INCHE JOSE ANTONIO</font></td>
	</tr>
	</table>
            	<table border="0" cellpadding="2" cellspacing="3" width="100%" class="form-table">
	          <tr>            	  
...
<!--	             </tr>  -->
			...
			<br>
                ...
                <td class="bg" colspan=3>         
                  ...
                  RECIBOS POR HONORARIOS     AFILIADO DESDE 31/05/2011
	    ...
	    <tr>
			<td align="center" valign="middle" colspan=1>
				<form name="forminfoHist" method="post" action="/cl-ti-itmrconsruc/jcrS00Alias">
				      ...
				      <input type="hidden" name="nroRuc" value="10443262399">
				      <input type="hidden" name="desRuc" value="GUILLERMO INCHE JOSE ANTONIO">
				</form>
			</td>
			<td align="center" valign="middle" colspan=1>
